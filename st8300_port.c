...
// DEFINE I/O
	...
	//  PINOS NÃO USADOS
	#define rd			PIN_G4
	#define RST_AD		PIN_G4
	#define CS_AD2		PIN_G4
	#define CS_AD3		PIN_G4
...
//equates de pinos controle do relógio
	...
	#define FLASH_HOLD	PIN_G4
	#define FLASH_WP	PIN_G4
	
	
	#define CA1			PIN_G4
	
	#define direcao2  	PIN_G4
	
	#define CSIO6		PIN_G4
	#define CSIO7		PIN_G4
	#define CSIO8		PIN_G4
	
	#define MCP3208_CLK  PIN_G4
	#define MCP3208_DOUT PIN_G4
	#define MCP3208_DIN  PIN_G4
	#define MCP3208_CS   PIN_G4
#else
	#define PGD			PIN_B7
	#define CA0			PIN_E3
