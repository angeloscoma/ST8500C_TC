...
; 		Registrador Portatil de Grandezas Eletricas Trifasico            *
...
#define protocolo_abb false
	...
	#define teste_protocolo_abb	 false			// APENAS NA DEPURACAO, DEPOIS TEM QUE FICAR EM FALSE
#endif
